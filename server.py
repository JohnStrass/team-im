#!/usr/bin/env python
"""team-im server - a tiny LAN instant-messaging hub for operator + the Claude instances.
...
<style>
  ...
  .server-owner { color: #9ecbff; } .other { color: #d8a8ff; }
...
function cls(w){ return ['operator','client-author','server-owner'].includes(w) ? w : 'other'; }
function add(m){
